...
<!-- Slide 2: Who am I -->
<section class="slide slide-two-column column-wide" use:scrollReveal>
	<div class="content-section">
...
<section class="slide slide-three-column column-wide" use:scrollReveal>
	<div class="content-section">
...
<!-- Slide 4: Community -->
<section class="slide slide-two-column slide-community column-wide" use:scrollReveal>
	<div class="content-section">
		...
		<ul>
			<li>
				<a href="https://curioss.org/" target="_blank" rel="noopener noreferrer">
					Community for University and Research Institution OSPOs (CURIOSS)
				</a>
			</li>
			<li>
			...
			<li>
				<a href="https://pydata.org/vermont2024/" target="_blank" rel="noopener noreferrer">
					PyData Vermont 2024 Conference
				</a>
			</li>
			<li>
				<a href="https://www.cscce.org/" target="_blank" rel="noopener noreferrer">
	...
	<div class="image-section">
		<div class="image-wrapper">
			...
			<div class="copyright">
				<p>
					Project illustration by Scriberia. Used under a CC-BY 4.0 licence. 
...
<section class="slide slide-two-column slide-value-proposition column-wide" use:scrollReveal>
	<div class="content-section">
...
<style>
	...
	/* Three-column layout (content | divider | image) */
	.slide-three-column {
		display: grid;
	...
	.slide-community .image-section img {
		width: 100%;
		min-width: 300px;
		max-width: none;
	}
    ...
    .content-section ul ul {
        margin-top: 0.5rem;
        margin-left: 1.5rem; /* Indent the entire nested list */
    }
	...
	/* Use :global() but target specific sections to avoid leakage */
	...
	/* Ensure content is visible if animations are disabled or JS fails */
