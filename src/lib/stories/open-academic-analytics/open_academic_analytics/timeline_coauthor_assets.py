"""
Simplified timeline_coauthor_assets.py
"""
import random
...
@dg.asset(deps=["paper_preprocessing"])
def timeline_coauthor_main(duckdb: DuckDBResource):
    """Main timeline-coauthor processing"""
    ...
    with duckdb.get_connection() as conn:
        ...
        # Load paper and author data
        paper_file = config.DATA_PROCESSED_DIR / config.PAPER_OUTPUT_FILE
        ...
        # Development mode: limit processing
        ...
        # Force update: clear existing records if needed
        if config.FORCE_UPDATE:
            ...
            for target_aid in target_aids:
                ...
                print(f"  Deleted {deleted_count} records for {target_aid}")
        ...
        print(f"\n🎉 Complete! Processed {len(targets)} authors, created {total_new_records} new coauthor records")
