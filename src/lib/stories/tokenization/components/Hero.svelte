...
<style>
	/* =============================================================================
	   ...
	   Uses design tokens from the parent story theme
	   ============================================================================= */
	...
	.hero-banner {
		...
		/* Inherit background from parent story theme */
	}
	...
	/* =============================================================================
	   ...
	   Uses semantic design tokens with story-specific overrides
	   ============================================================================= */
	...
	.construction-note {
		...
		color: #d21e1e; /* Brownish-orange that fits parchment */
		font-style: italic;
