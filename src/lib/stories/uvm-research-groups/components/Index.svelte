<script lang="ts">
    ...
    import coauthor from '../data/coauthor.csv';
    ...
    let chosen_author = coauthor.filter(d=>d.aid == 'A5040821463');
    console.log(chosen_author);
...
<!-- In your Index.svelte, replace the plot-container section with: -->
<div class="plot-container">
  <BubbleChart scrollyIndex={value} data={chosen_author} />
</div>
